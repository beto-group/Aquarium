...
<div align="center">
  ...
  <h3 align="center"> A Gᴀᴍɪғɪᴇᴅ ᴀɴᴅ Iɴᴛᴇʀᴀᴄᴛɪᴠᴇ Lᴏᴛᴛɪᴇ-PᴏᴡGVʀᴇᴅ Tᴀsᴋ Aǫᴜᴀʀɪᴜᴍ </h3>
</div>
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/RUNTIME-PUREJS-000?style=for-the-badge&logo=data:image/svg+xml;base64," alt="RUNTIME">
  <hr>
</div>

<img src="assets/aquarium.clip.gif" alt="Aquarium Walkthrough" width="100%">

<div align="center">
  <p><i>A gamified, interactive visualizer that renders lists of tasks or habits as animated fish swimming in a dynamic Lottie-powered aquarium.</i></p>
</div>
...
The component manages responsive scaling calculations to ensure the swim area perfectly aligns with the container aspect ratio, handles lazy-loading and caching of Lottie dependencies, suppresses standard status bar footers for an immersive experience, and contains a draggable visual boundaries debugger for developer configuration.
...
| **[_RESOURCES/DATACORE/_DONE/AQUARIUM/src/index.jsx](_RESOURCES/DATACORE/_DONE/AQUARIUM/src/index.jsx)** | Main loader hook that resolves paths and wraps the application within JSX boundaries. |
| **[_RESOURCES/DATACORE/_DONE/AQUARIUM/src/App.jsx](_RESOURCES/DATACORE/_DONE/AQUARIUM/src/App.jsx)** | View coordinator that resolves fuzzy file names, handles status bar suppression, and renders compact/full-tab nodes. |
| **[Aquarium.jsx](Aquarium.jsx)** | Manages background Lottie renderers, debug panel actions, and layout width scaling. |
| **[FishComponent.jsx](FishComponent.jsx)** | Handles animation loop triggers, vector positions, hovered states, and tooltip DOM overlays. |
| **[_RESOURCES/DATACORE/_DONE/AQUARIUM/src/utils/loadScript.js](_RESOURCES/DATACORE/_DONE/AQUARIUM/src/utils/loadScript.js)** | Dynamic utility that handles script downloads and writes them to the local vault adapter cache. |
| **[METADATA.md](_RESOURCES/DATACORE/_DONE/AQUARIUM/METADATA.md)** | Machine-readable indexing manifest outlining component capabilities, type, and contributors. |
| **[CONTRIBUTION.md](_RESOURCES/DATACORE/_DONE/AQUARIUM/CONTRIBUTION.md)** | Contributor architecture specifications and development guidelines. |
| **[LICENSE.md](_RESOURCES/DATACORE/_DONE/AQUARIUM/LICENSE.md)** | MIT open-source license. |
